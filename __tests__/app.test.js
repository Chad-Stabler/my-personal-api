...
describe('backend-express-template routes', () => {
  ...
  it('/games should return a list of ids and game titles', async () => {
  ...
  it('/games/:id should return a single game of data', async () => {
    const resp = await request(app).get('/games/3');
